...
import wlroots.xwayland as xwayland
...
class Core():
    def __init__(self) -> None:
        ...
        self.seat = seat.Seat(self.display, "NextWM-Seat0")
        ...
        self.xwayland = xwayland.XWayland(self.display, self.compositor, True) # True -> lazy evaluation. A.K.A XWayland is started when a client needs it.
